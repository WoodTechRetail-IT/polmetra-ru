...
namespace liveopencart\lib\v0005;
...
class ControllerAdminExtension extends \Controller {
	...
	*/
	...
	protected function getRouteExtension($custom_code='') {
		return 'extension/'.$this->extension_type.'/'.( $custom_code ? $custom_code : $this->extension_code);
	}
