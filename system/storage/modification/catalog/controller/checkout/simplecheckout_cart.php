...
class ControllerCheckoutSimpleCheckoutCart extends SimpleController {
    ...
    public function index() {
            ...
            $this->_templateData['button_cart'] = $this->language->get('button_cart');
            $this->_templateData['button_cancel'] = $this->language->get('button_cancel');
            $this->_templateData['text_option'] = $this->language->get('text_option');
            ...
            $this->_templateData['datetime_language'] = $this->session->data['language'];
            // end gift price      
        ...
        $this->_templateData['has_error']                = $this->simplecheckout->hasError('cart');
            ...
            // gift
            $this->_templateData['gift'] = $this->load->controller('extension/gift_price/gift');
            // end gift
