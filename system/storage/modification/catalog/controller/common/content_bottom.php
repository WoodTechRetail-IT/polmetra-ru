...
class ControllerCommonContentBottom extends Controller {
	public function index() {
        ...
        if ($route == 'extension/module/fly_pages' && isset($this->request->get['fly_page_id'])) {
            $this->load->model('extension/module/fly_pages');
            $layout_id = $this->model_extension_module_fly_pages->getPageLayoutId($this->request->get['fly_page_id']);
        }
