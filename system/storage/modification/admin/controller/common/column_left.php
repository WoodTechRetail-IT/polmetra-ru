...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/gift_setting')) {
                $gift[] = array(
                  'name' => $this->language->get('text_gift_setting'),
                  'href' => $this->url->link('catalog/gift_setting', 'user_token=' . $this->session->data['user_token'], true),
                  'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'catalog/gift_price')) {
                $gift[] = array(
                  'name' => $this->language->get('text_gift_price_summ'),
                  'href' => $this->url->link('catalog/gift_price', 'user_token=' . $this->session->data['user_token'], true),
                  'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'catalog/gift_count_all')) {
                $gift[] = array(
                  'name' => $this->language->get('text_gift_count_all'),
                  'href' => $this->url->link('catalog/gift_count_all', 'user_token=' . $this->session->data['user_token'], true),
                  'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'catalog/gift_count_product')) {
                $gift[] = array(
                  'name' => $this->language->get('text_gift_count_product'),
                  'href' => $this->url->link('catalog/gift_count_product', 'user_token=' . $this->session->data['user_token'], true),
                  'children' => array()
                );
            }
            ...
            if ($gift) {
                $catalog[] = array(
                  'name' => $this->language->get('text_gift_price'),
                  'href' => '',
                  'children' => $gift
                );
            }
      ...
      // OCFilter end
            ...
            if ($this->user->hasPermission('access', 'catalog/ldev_question')) {
                $catalog[] = array(
                    'name'	   => '✔ Accordion & Tabs & Steps',
                    'href'     => $this->url->link('catalog/ldev_question', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
			...
			// Handy Product Manager . Begin
			if ($this->config->get('module_handy_product_manager_status')) {
				$this->load->language('extension/module/handy_product_manager');

				if ($this->user->hasPermission('access', 'extension/module/handy_product_manager')) {
					$hpm[] = array(
						'name'	   => $this->language->get('text_edit'),
						'href'     => $this->url->link('extension/module/handy_product_manager', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()
					);
        
					$hpm[] = array(
						'name'	   => $this->language->get('text_hpm_product'),
						'href'     => $this->url->link('extension/module/handy_product_manager/productList', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()
					);

					$hpm[] = array(
						'name'	   => $this->language->get('text_hpm_mass_edit'),
						'href'     => $this->url->link('extension/module/handy_product_manager/massEdit', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()
					);
					...
					$data['menus'][] = array(
						...
						'name'	   => $this->language->get('text_hpm_menu'),
						'href'     => '',
						'children' => $hpm
					);
