...
class ControllerCommonHeader extends Controller {
	public function index() {
		$data['title'] = $this->document->getTitle();
                ...
                if($this->config->get('module_imagemanagersettings_themes') == 'mt'){
                    $this->document->addStyle('view/javascript/imagemanager/elFinder/css/material/css/theme.min.css');
                }elseif($this->config->get('module_imagemanagersettings_themes') == 'mtg'){
                    $this->document->addStyle('view/javascript/imagemanager/elFinder/css/material/css/theme-gray.min.css');
                }elseif($this->config->get('module_imagemanagersettings_themes') == 'mtl'){
                    $this->document->addStyle('view/javascript/imagemanager/elFinder/css/material/css/theme-light.min.css');
                }elseif($this->config->get('module_imagemanagersettings_themes') == 'win'){
                    $this->document->addStyle('view/javascript/imagemanager/elFinder/css/windows/css/theme.css');
                }
