<?php
defined('OCMOD_WORKING') || define('OCMOD_WORKING', true);
			
defined('EXTENSION_NAME')           || define('EXTENSION_NAME',            'Admin Quick Edit PRO');
defined('EXTENSION_VERSION')        || define('EXTENSION_VERSION',         '6.3.0');
...
defined('EXTENSION_STORE_URL')      || define('EXTENSION_STORE_URL',       '' . EXTENSION_ID);
defined('EXTENSION_PURCHASE_URL')   || define('EXTENSION_PURCHASE_URL',    '' . EXTENSION_ID);
defined('EXTENSION_SUPPORT_EMAIL')  || define('EXTENSION_SUPPORT_EMAIL',   '');
defined('EXTENSION_SUPPORT_FORUM')  || define('EXTENSION_SUPPORT_FORUM',   '');
defined('OTHER_EXTENSIONS')         || define('OTHER_EXTENSIONS',          '');
...
class ControllerExtensionModuleAdminQuickEdit extends Controller {
	...
	private static $column_defaults = array(
		...
		'module_admin_quick_edit_catalog_recurrings' => array(
			...
			'status'            => array('display' => 0, 'qe_status' => 1, 'editable' => 1, 'index' =>  20, 'align' =>   'text-left', 'type' =>  'status_qe', 'sort' =>            'r.status', 'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
			...
			'trial_status'      => array('display' => 0, 'qe_status' => 1, 'editable' => 1, 'index' =>  45, 'align' =>   'text-left', 'type' =>  'status_qe', 'sort' =>      'r.trial_status', 'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
		...
		'module_admin_quick_edit_customer_customers' => array(
			...
			'newsletter'        => array('display' => 0, 'qe_status' => 1, 'editable' => 1, 'index' =>  30, 'align' =>   'text-left', 'type' =>  'yes_no_qe', 'sort' =>        'c.newsletter', 'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
			...
			'safe'              => array('display' => 0, 'qe_status' => 1, 'editable' => 1, 'index' =>  50, 'align' =>   'text-left', 'type' =>  'yes_no_qe', 'sort' =>              'c.safe', 'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
			...
			'affiliate_status'  => array('display' => 1, 'qe_status' => 1, 'editable' => 1, 'index' =>  85, 'align' =>   'text-left', 'type' =>  'status_qe', 'sort' =>           'ca.status', 'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
		...
		'module_admin_quick_edit_sale_returns' => array(
			...
			'opened'            => array('display' => 0, 'qe_status' => 1, 'editable' => 1, 'index' =>  60, 'align' =>   'text-left', 'type' =>  'yes_no_qe', 'sort' =>           'r.opened', 'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false), 'rel' => array('date_modified')),
		...
		'module_admin_quick_edit_marketing_coupons' => array(
			...
			'logged'            => array('display' => 0, 'qe_status' => 1, 'editable' => 1, 'index' =>  40, 'align' =>   'text-left', 'type' =>  'yes_no_qe', 'sort' =>            'c.logged', 'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
			'shipping'          => array('display' => 0, 'qe_status' => 1, 'editable' => 1, 'index' =>  45, 'align' =>   'text-left', 'type' =>  'yes_no_qe', 'sort' =>          'c.shipping', 'filter' => array('show' => 1, 'type' => 1, 'autocomplete' => false)),
	...
	private function installedVersion() {
		...
		return $installed_version ? $installed_version : '6.3.0';
	}
}
