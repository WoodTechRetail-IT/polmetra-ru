...
class ControllerBlogCategory extends Controller {
    ...
    // SEO URL Generator PRO . begin
		...
		$data['blog_category_id'] = isset($this->request->get['blog_category_id']) ? $this->request->get['blog_category_id'] : false;
		...
		$this->load->language('blog/category'); // for heading_title no conflict
		
		if (isset($this->request->get['blog_category_id'])) {
			if (isset($this->request->post['seo_url_generator_redirects'])) {
				$data['redirects'] = $this->request->post['seo_url_generator_redirects'];
			} else {
				$data['redirects'] = $this->model_extension_module_seo_url_generator->getRedirects('blog_category_id', $this->request->get['blog_category_id']);
			}
		} else {
